...
Public Class CalibrationOverlayForm
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        DrawRegion(e.Graphics, "disconnect_ok_rect", _currentConfig.DisconnectOkRect, Color.FromArgb(170, 255, 175, 90), "Disconnect OK")
    ...
    Private Function HitTestRegion(pt As System.Drawing.Point) As String
        Dim keys As String() = {"resurrect_scan_rect", "chat_rect", "map_coordinate_y_rect", "map_coordinate_x_rect", "disconnect_ok_rect", "disconnect_message_rect", "party_list_rect", "party_invite_ok_rect", "party_invite_scan_rect", "rupiahs_rect", "prana_exp_rect", "unreachable_text_rect", "mob_life_rect", "mob_hp_rect", "mob_name_rect", "mp_bar", "hp_bar"}
    ...
    Private Function GetRegionByKey(regionKey As String) As RectRegion
        ...
        Select Case regionKey.ToLowerInvariant()
            ...
            Case "disconnect_ok_rect"
                Return _currentConfig.DisconnectOkRect
    ...
    Private Sub SetRegionByKey(regionKey As String, value As RectRegion)
        Select Case regionKey.ToLowerInvariant()
            ...
            Case "disconnect_ok_rect"
                _currentConfig.DisconnectOkRect = value
            Case "map_coordinate_x_rect"
    ...
    Private Function CloneConfig(src As BotConfig) As BotConfig
        ...
        cfg.DisconnectOkRect = CloneRegion(src.DisconnectOkRect)
