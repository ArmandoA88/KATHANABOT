// Decompile a bounded caller tree for one or more internal functions.
// Usage: GhidraCallerTreeDump.java <output> <depth> <address> [address...]
// @category Kathana
...
public class GhidraCallerTreeDump extends GhidraScript {
    private static final int MAX_FUNCTIONS = 400;
    ...
    protected void run() throws Exception {
        ...
        println("Caller tree written to " + output.getAbsolutePath());
    }
}
